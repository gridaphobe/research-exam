#+TITLE: Automated Specification-Based Testing
#+AUTHOR:
#+DATE:
...
** Implementation
We have implemented Target as a testing library for Haskell programs, and have
compared it against QuickCheck and (Lazy) SmallCheck on a series of functions
with complex preconditions. We checked properties of a custom red-black tree
...
consistently able to explore /deeper/ inputs than (Lazy) SmallCheck before timing
out.
